          ...
          <div className="flex items-center gap-2 sm:gap-4 md:gap-8">
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                ...
                className="relative overflow-hidden cursor-pointer w-fit py-1.5 sm:py-2 md:py-2.5 px-3 sm:px-4 md:px-5 border border-border hover:border-primary/50 bg-background/50 backdrop-blur-sm rounded-full group shadow-sm transition-all duration-300"
              >
                ...
                <span className="relative z-10 text-[11px] sm:text-xs md:text-sm font-medium text-foreground transition-colors duration-300 whitespace-nowrap flex items-center gap-2">
